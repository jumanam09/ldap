            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('tclientes.index') }}">{{ __('T_cliente') }}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('tfacturas.index') }}">{{ __('T_factura') }}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('departamentos.index') }}">{{ __('Depa') }}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('ciudades.index') }}">{{ __('Ciudad') }}</a>
                        </li>
